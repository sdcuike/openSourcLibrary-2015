...
public class Reflect {
	 ...
	 * <p>
	 * To prevent {@link SecurityException}, this is only done if the argument object and its declaring class are non-public.
	 *
	 * @param accessible
	 ...
	 * accessing static fields and methods), or any other type of {@link Object} (for accessing instance fields and methods).
	 */
	 ...
	 * Get a wrapped field.
	 * <p>
	 * This is roughly equivalent to {@link Field#get(Object)}. If the wrapped object is a {@link Class}, then this will wrap a static member field. If the wrapped object is any other {@link Object}, then this wrap an instance member field.
	 *
	 * @param name
	 *            The field name
	 ...
	 * <p>
	 * Just like {@link Method#invoke(Object, Object...)}, this will try to wrap primitive types or unwrap primitive type wrappers if applicable. If several methods are applicable, by that rule, the first one encountered is called. i.e. when calling <code><pre>
	 * on(...).call("method", 1, 1);
	 ...
	 * <p>
	 * If a public method is found in the class hierarchy, this method is returned. Otherwise a private method with the exact same signature is returned. If no exact match could be found, we let the {@code NoSuchMethodException} pass through.
	 */
	 ...
	 * <p>
	 * First public methods are searched in the class hierarchy, then private methods on the declaring class. If a method could be found, it is returned, otherwise a {@code NoSuchMethodException} is thrown.
	 */
	 ...
	 * <p>
	 * Just like {@link Constructor#newInstance(Object...)}, this will try to wrap primitive types or unwrap primitive type wrappers if applicable. If several constructors are applicable, by that rule, the first one encountered is called. i.e. when calling <code><pre>
	 ...
	 */
	@SuppressWarnings("unchecked")
	public <P, T> P as(Class<P> proxyType, Consumer<T> before, Consumer<T> after, T t) {
		...
		final InvocationHandler handler = new InvocationHandler() {
			...
			public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
				...
				try {
					before.accept(t);
					Object result = on(object).call(name, args).get();
					after.accept(t);
					return result;
				}
